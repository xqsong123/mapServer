...
public class TileDownLoadServiceImp {

    private Log log = LogFactory.getLog(TileDownLoadServiceImp.class);
    ...
    public static Polygon buildPolygon(Random random, int pointCount, GeometryFactory geomFactory) {
        if(pointCount < 3) {
    ...
    public static LineString buildLineString(Random random, int pointCount, GeometryFactory geomFactory) {
        final CoordinateSequence coordSeq = getCoordSeq(random, pointCount, geomFactory);
    ...
    public static Point createPoint1(String name) {
    ...
    public static MultiPoint buildMultiPoint(Random random, int pointCount, GeometryFactory geomFactory) {
        final CoordinateSequence coordSeq = getCoordSeq(random, pointCount, geomFactory);
        return geomFactory.createMultiPoint(coordSeq);
    }

    public static VectorTile.Tile encodeMvt(MvtLayerParams mvtParams, TileGeomResult tileGeom) {
    ...
    public static Collection<Geometry> getPoints(Point... points) {
    ...
    public static Collection<Geometry> getPoints() {
        return getPoints(
