...
public class GeometryCreator {
     ...
     * @return
     */
    public Point createPoint(double x, double y, Map attrs){
        Coordinate coord = new Coordinate(x, y);
        Point point = geometryFactory.createPoint(coord);
        if(attrs != null){
            point.setUserData(attrs);
        }
        return point;
    }
     ...
     */
    public Point createPointByWKT(String PointWKT, Map attrs) throws ParseException{
